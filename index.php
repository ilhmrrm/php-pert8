...
<body>
        ...
        <thead>
            ...
            <tbody>
                ...
                $no = 1;
                $query = mysqli_query($conn, "SELECT * FROM mahasiswa_npm");
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="update.php?id=<?php echo $row['id_mahasiswa'] ?>" class="btn btn-sm btn-warning">EDIT</a>
                                <a href="delete.php?id=<?php echo $row['id_mahasiswa'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                            </td>
                        </tr>
                <?php } ?>
            </tbody>
