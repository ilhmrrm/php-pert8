<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE mahasiswa_npm SET nama='$nama', npm='$npm', materi_kursus='$materi_kursus' WHERE id_mahasiswa=$id";
        ...
        $id = $_GET['id'];
        $fetch_data_query = "SELECT * FROM mahasiswa_npm WHERE id_mahasiswa=$id";
